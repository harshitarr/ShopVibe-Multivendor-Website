...
const StoreInfo = ({store}) => {
    return (
        <div className="flex-1 space-y-2 text-sm">
            <Image width={100} height={100} src={store.logo || '/default-store.png'} alt={store.name || 'Store'} className="max-w-20 max-h-20 object-contain shadow rounded-full max-sm:mx-auto" />
            ...
            {store.user && (
                <div className="flex items-center gap-2 text-sm ">
                    ...
                    <div>
                            ...
                            {store?.user?.name?.split(" ")[0] || "Unknown User"}
                            </p>                        
